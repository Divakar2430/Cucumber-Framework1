...
public class stepDefinition1 {
	...
	public void user_is_on_demo_guru_page() {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\Admin\\Desktop\\Divakar\\FrameworkProject1\\driver\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.get("https://www.demo.guru99.com");
		driver.manage().window().maximize();
		WebElement protection = driver.findElement(By.xpath("//button[@id = 'details-button']"));
		protection.click();
		WebElement security = driver.findElement(By.xpath("//a[@id='proceed-link']"));
		security.click();
	}
	...
	public void user_enters_the_details_with_the_firstname_lastname_email_address(
